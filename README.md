...
*Schema diagram made at ![QuickDataBaseDiagrams.com](<http://app.quickdatabasediagrams.com>), using SQL_to_EDL.py in this repo (so inconsistency with actual db schema is possible!)*
