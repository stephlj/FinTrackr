...
class TestPlotAccntBalances(unittest.TestCase):
    ...
    def test_relative_bal_by_date(self):
        ...
        rel_bals_4 = plot.relative_bal_by_date(rel_to=[Transaction(date=date(year=2026,month=1,day=1), amount=5000.00)], transactions=self.trans)
        ...
        rel_bals_5 = plot.relative_bal_by_date(rel_to=[Transaction(date=date(year=2023, month=10, day=5), amount=2500.00)], transactions=self.trans)
        ...
        rel_bals_6 = plot.relative_bal_by_date(rel_to=[Transaction(date=date(year=2023, month=10, day=4),amount=2500.00)], transactions=self.trans)
